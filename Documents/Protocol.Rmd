...
")
  ...
  **JMR** is an employee of Janssen Research and Development and shareholders in John & Johnson.
...
In this study we will use LASSO logistic regression, GBM and random forest.  We will use 3-fold cross-validation on a 75% train set to select the optimal varience (amount of reguarlization) and use a 25% test set for internal validation performance estimation.
